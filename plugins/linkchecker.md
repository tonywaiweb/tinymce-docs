...
> Please note that Link Checker is a premium plugin and relies on a server-side service, which is included as a part of a [premium subscription](https://www.tinymce.com/pricing/).
